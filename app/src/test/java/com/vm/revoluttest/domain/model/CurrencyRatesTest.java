...
public class CurrencyRatesTest {
    ...
    public Type mapType = new TypeToken<EnumMap<Currency, Double>>() {}.getType();
    ...
    public void parseModel(){
        ...
        assertEquals(rates.getRates().get(Currency.EUR), Double.valueOf(0.83893));
        assertEquals(rates.getRates().get(Currency.GBP), Double.valueOf(0.77244));
    }
